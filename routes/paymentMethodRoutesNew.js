...
router.get('/:userId/payment-methods', function(req, res, next) {
...
router.post('/:userId/payment-methods', function(req, res, next) {
    authMiddleware(req, res, async function() {
        try {
...
router.delete('/:userId/payment-methods/:methodId', function(req, res, next) {
    authMiddleware(req, res, async function() {
        try {
...
router.put('/:userId/payment-methods/default', function(req, res, next) {
    authMiddleware(req, res, async function() {
        try {
...
router.get('/:userId/payment-methods/:methodId', function(req, res, next) {
    authMiddleware(req, res, async function() {
        try {
            // Ensure the user can only access their own payment methods (or admin can access any)
            if (req.user.id !== parseInt(req.params.userId) && req.user.role !== 'admin') {
